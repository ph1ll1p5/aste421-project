...
#include <asteIMU/IMUDeployment/Top/IMUDeploymentTopologyDefs.hpp>
 ...
 *
 * For an explanation of the required type asteIMU::TopologyState see: asteIMUTopologyDefs.hpp.
 *
