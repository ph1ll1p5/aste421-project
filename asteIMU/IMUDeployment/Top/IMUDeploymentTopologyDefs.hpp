 ...
 */
namespace PingEntries {
    namespace asteIMU_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
    namespace asteIMU_rateGroup2 {enum { WARN = 3, FATAL = 5 };}
    namespace asteIMU_rateGroup3 {enum { WARN = 3, FATAL = 5 };}
    namespace asteIMU_cmdSeq {enum { WARN = 3, FATAL = 5 };}
}  // namespace PingEntries
 ...
 *
 * The topology autocoder requires an object that carries state with the name `asteIMU::TopologyState`. Only the type
