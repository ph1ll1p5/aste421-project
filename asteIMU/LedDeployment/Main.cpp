...
#include <asteIMU/LedDeployment/Top/LedDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    LedDeployment::TopologyState inputs;
    ...
    LedDeployment::setupTopology(inputs);
    LedDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    LedDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
